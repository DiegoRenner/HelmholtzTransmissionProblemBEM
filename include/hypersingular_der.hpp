 ...
 *        derivative in \p k of the Hypersingular BIO for the Helmholtz kernel, using
 *        common and composite Gauss-Legendre quadrature rules.
 *
 * This File is a part of the HelmholtzTransmissionProblemBEM library.
 */

#ifndef HYPERSINGULARDERHPP
#define HYPERSINGULARDERHPP
...
/**
 * \namespace hypersingular_helmholtz_der 
 * \brief This namespace contains all the functions for evaluating the derivative in \p k of
 * the Hypersingular Galerkin Matrix using common and composite Gauss-Legendre
 * quadrature rules.
 */
 ...
 * in \p k of the Hypersingular BIO for the Helmholtz Wernel, using the given trial and test spaces.
 ...
 * @return the matrix W' for the derivative in \p k of the
 ...
 * derivative in \p k of the Hypersingular BIO for the Helmholtz kernel,
 ...
 * bilinear form induced by the derivative in k of the Hypersingular BIO for
 ...
 * &&&\cdot& \Big[ 2\sqrt{c}k\hat{b}^{j}(t) \hat{b}^{i}(s) 
 ...
 * derivative in \p k of the bilinear form for Hypersingular BIO for the
 * Helmholtz kernel. It uses the trial and test spaces
