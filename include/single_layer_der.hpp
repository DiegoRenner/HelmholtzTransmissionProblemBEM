 ...
 *        derivative in \p k of the Single Layer BIO for the Helmholtz kernel, using
...
/**
 * \namespace single_layer_helmholtz_der 
 ...
 * in \p k of the Single Layer BIO for the Helmholtz Vernel, using the given trial and test spaces.
 ...
 * derivative in \p k of the Single Layer BIO for the Helmholtz kernel,
 ...
 * bilinear form induced by the derivative in k of the Single Layer BIO for
 * the Helmholtz kernel,
 * given the formula:
 * \f{eqnarray*}{ 
 * I_{ij} = -\frac{i\sqrt{c}}{4} \int_{0}^{1} \int_{0}^{1}
 * H_1^{(1)}(k\sqrt{c}\|\gamma_{\Pi}(s)-\gamma_{\Pi'}(t)\|) \|\gamma_{\Pi}(s)-\gamma_{\Pi'}(t)\|
