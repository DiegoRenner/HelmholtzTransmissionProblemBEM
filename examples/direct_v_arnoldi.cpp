 ...
 *
 * <tt>
 * /path/to/direct_v_arnoldi \<radius of circle\> \<number of SVs to be computed\>
 * \<accurracy of arnoldi algorithm\>.
 * </tt>
 *
 * The script will generate four files:
 * file_vals_eig_\<number of SVs to be computed\>_\<accurracy of arnoldi algorithm\>.dat,
 * file_vals_arpp_\<number of SVs to be computed\>_\<accurracy of arnoldi algorithm\>.dat,
 * file_timings_\<number of SVs to be computed\>_\<accurracy of arnoldi algorithm\>.dat,
 * file_iter_\<number of SVs to be computed\>_\<accurracy of arnoldi algorithm\>.dat.
 * These will contain the SVs computed using the direct solver, the SVs computed using
 * the Arnoldi algorithm, the time taken by the direct solver and the Arnoldi algorithm,
