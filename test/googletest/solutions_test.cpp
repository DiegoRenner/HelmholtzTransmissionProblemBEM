...
TEST(FuntionsTest, Bessel){
    ...
    ASSERT_NEAR(complex_bessel::Jp(0.0,M_PI).real(),-0.284615343179752757345310599686,tol);
    ...
    ASSERT_NEAR(complex_bessel::H1p(0.0,0.1).imag(),6.45895,100*sqrt_epsilon);
    ASSERT_NEAR(complex_bessel::H1p(0.0,0.1).real(),-0.0499375,100*sqrt_epsilon);
